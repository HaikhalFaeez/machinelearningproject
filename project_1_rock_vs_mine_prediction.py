# -*- coding: utf-8 -*-
"""Project 1 - Rock vs Mine Prediction.ipynb
...
1.   A sonar was emitted from a submarine to identified an object whether it is a rock (soil/rock) or a mine (steel) - Binary Classification Problem
2.   ML Model - Logistic Regression Model (Supervised ML)
3.   Work Flow
     * Collect Sonar Data - Kaggle Dataset
     * Data Pre-Processing
     * Train-Test Split
     * Machine Learning Training - Logistic Regression Model (Supervise ML)
     * Develop Prediction System - Feed new data to the trained model to predict the object
